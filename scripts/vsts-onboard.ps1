...
$vstsInternalInstance = "https://dotnet.visualstudio.com/internal"  
...
# Check that the repo doesn't already exist on dotnet.visualstudio.com's internal instance.  Unfortunately
