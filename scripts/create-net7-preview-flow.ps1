...
MakeDefaultChannel https://github.com/dotnet/linker $SdkBranch $SdkChannel
...
AddArcadeFlow https://github.com/dotnet/linker $SdkBranch
...
AddFlow https://github.com/dotnet/linker $SdkChannel https://github.com/dotnet/sdk $SdkBranch EveryBuild
