...
namespace Microsoft.DotNet.Build.Tasks.VisualStudio
{
    ...
    /// </summary>
    public sealed class GenerateSpeedometerPropsFile : Task
    {
        private const string ProductDropNamePrefix = "Products/";
        private const string TestsDropNamePrefix = "Tests/";
        private const string SpeedometerDropFolder = "SpeedometerInputs";
        ...
        private void ExecuteImpl()
        {
            ...
            var outputFileNameNoExt = string.IsNullOrEmpty(RepositoryName) ? TestsDropNamePrefix : RepositoryName.Replace('/', '.');
...
<Project>
  <ItemGroup>
    <TestStore Include=""vstsdrop:{TestsDropNamePrefix}/{dropName}/{SpeedometerDropFolder}"" />
  </ItemGroup>
