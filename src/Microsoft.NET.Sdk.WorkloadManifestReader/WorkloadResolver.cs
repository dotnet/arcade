...
namespace Microsoft.NET.Sdk.WorkloadManifestReader
{
    ...
    public class WorkloadResolver : IWorkloadResolver
    {
        ...
        public void ReplaceFilesystemChecksForTest(Func<string, bool> fileExists, Func<string, bool> directoryExists)
        {
...
#nullable restore
        ...
        public IEnumerable<WorkloadPackId> GetPacksInWorkload(WorkloadDefinition workload)
        {
