...
{
    public class WorkloadSuggestionFinder
    {
        ...
        public static void FindPartialSuggestionsAndSimpleCompleteSuggestions(
        ...
        public static HashSet<WorkloadSuggestionCandidate> GatherUniqueCompletePermutedSuggestions(List<WorkloadSuggestionCandidate> partialSuggestions)
        {
        ...
        /// </summary>
        public static HashSet<WorkloadSuggestionCandidate> FilterRedundantSuggestions(HashSet<WorkloadSuggestionCandidate> completeSuggestions)
        {
        ...
        public static WorkloadSuggestion GetBestSuggestion(ICollection<WorkloadSuggestion> suggestions) => FindBest(
                suggestions,
        ...
        /// </summary>
        public class WorkloadSuggestionCandidate : IEquatable<WorkloadSuggestionCandidate>
        {
        ...
        public class WorkloadSuggestion
        {
            ...
            /// </summary>
            public HashSet<WorkloadDefinitionId> Workloads { get; set; }
