...
namespace Microsoft.DotNet.Helix.JobMonitor
{
    ...
    public interface IHelixService
    {
        ...
        /// <summary>
        /// Returns work item details for a completed Helix job, including exit codes.
        /// </summary>
        Task<HelixJobPassFail> GetJobPassFailAsync(string jobName, CancellationToken cancellationToken);
