...
def analyze_operation(command: str, platform: str, isDevice: bool, target: str, exitCode: int):
    ...
    if platform is "android":
        ...
        if isDevice:
            ...
            if exitCode is 81: # DEVICE_NOT_FOUND
            ...
            if exitCode is 83: # APP_LAUNCH_FAILURE
            ...
            if exitCode is 81 and '_' not in target: # DEVICE_NOT_FOUND
            ...
            if exitCode is 86: # APP_INSTALLATION_TIMEOUT
            ...
            if exitCode is 88: # SIMULATOR_FAILURE
...
for operation in operations:
    ...
    analyze_operation(command, platform, isDevice, target, exitCode)
