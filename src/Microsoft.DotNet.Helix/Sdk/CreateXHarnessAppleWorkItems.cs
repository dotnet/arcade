...
namespace Microsoft.DotNet.Helix.Sdk
{
    ...
    public class CreateXHarnessAppleWorkItems : XHarnessTaskBase
    {
        ...
        {
            var zipArchiveManager = new ZipArchiveManager();
            ...
            var provisioningProfileProvider = new ProvisioningProfileProvider(
                Log, helpers, fileSystem, zipArchiveManager, httpClient, retryHandler, ProvisioningProfileUrl, TmpDir);
