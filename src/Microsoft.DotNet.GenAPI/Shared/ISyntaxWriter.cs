...
public interface ISyntaxWriter : IDisposable
{
    ...
    /// <summary>
    /// Writes type delegate with corresponding accessibility.
    /// </summary>
    /// <param name="accessibility">List of accessibility: public, private, protected, internal, etc.</param>
    /// <param name="typeName">Type name without namespaces</param>
    /// <param name="keywords">List of keywords: struct, partial, ref, class, readonly, etc.</param>
    ...
    /// </summary>
    /// <param name="accessibilities">List of accessibility: public, private, protected, internal, etc.</param>
    ...
    void WriteProperty(IEnumerable<SyntaxKind> accessibilities, string definition, bool hasImplementation, bool hasGetMethod, bool hasSetMethod);
    ...
    void WriteEvent(IEnumerable<SyntaxKind> accessibilities, string definition, bool hasAddMethod, bool hasRemoveMethod);
    ...
    ///     If not - implementation should be ommited.</param>
    void WriteMethod(IEnumerable<SyntaxKind> accessibilities, string definition, bool hasImplementation);
    ...
    void WriteField(IEnumerable<SyntaxKind> accessibilities, string definition);
}
