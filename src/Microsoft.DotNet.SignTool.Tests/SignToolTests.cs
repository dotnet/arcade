...
namespace Microsoft.DotNet.SignTool.Tests
{
    public class SignToolTests : IDisposable
    {
        ...
        public void SkipSigning()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>
            {
                { new ExplicitCertificateKey("NativeLibrary.dll"), new FileSignInfoEntry("None") },
                { new ExplicitCertificateKey("ProjectOne.dll", publicKeyToken: "581d91ccdfc4ea9c", targetFramework: ".NETCoreApp,Version=v2.1"), new FileSignInfoEntry("None") }
            };
...
"
        ...
        public void OnlyContainerAndOverridingByPKT()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("ProjectOne.dll", "581d91ccdfc4ea9c"), new FileSignInfoEntry("OverriddenCertificate") }
            };
        ...
        public void OnlyContainerAndOverridingByFileName()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("NativeLibrary.dll", collisionPriorityId: "123"), new FileSignInfoEntry("OverriddenCertificate1") },
                { new ExplicitCertificateKey("ProjectOne.dll", collisionPriorityId: "123"), new FileSignInfoEntry("3PartySHA2") }
            };
        ...
        public void EmptyPKT()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("EmptyPKT.dll"), new FileSignInfoEntry("3PartySHA2") }
            };
        ...
        public void CrossGenerated()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("EmptyPKT.dll", collisionPriorityId: "123"), new FileSignInfoEntry("3PartySHA2") }
            };
...
<FilesToSign Include=""{Uri.EscapeDataString(Path.Combine(_tmpDir, "AspNetCoreCrossLib.dll"))}"">
  <Authenticode>Microsoft400</Authenticode>
        ...
        public void CustomTargetFrameworkAttribute()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("CustomTargetFrameworkAttribute.dll", targetFramework: ".NETFramework,Version=v2.0", collisionPriorityId: "123"), new FileSignInfoEntry("3PartySHA2") }
            };
...
<FilesToSign Include=""{Uri.EscapeDataString(GetResourcePath("NestedContainer.1.0.0.nupkg"))}"">
  <Authenticode>NuGet</Authenticode>
        ...
        public void NestedContainerWithCollisions()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("ContainerOne.dll", collisionPriorityId: "456"), new FileSignInfoEntry("OverriddenCertificate1") }
            };
...
"
        ...
        public void SignArchivesUsingDetachedSignature()
        {
            ...
            // Overriding information
            var explicitCertKeys = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("test.zip"), new FileSignInfoEntry("ArchiveCert") },
                { new ExplicitCertificateKey("test.tgz"), new FileSignInfoEntry("ArchiveCert") },
                { new ExplicitCertificateKey("InnerZipFile.zip"), new FileSignInfoEntry("ArchiveCert") }
            };
...
"
        ...
        public void SignAndNotarizePkgFile()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("test.pkg"), new FileSignInfoEntry("MacDeveloperHardenWithNotarization") }
            };
  ...
  <Authenticode>LinuxSign</Authenticode>
        ...
        public void VerifyNupkgIntegrity()
        {
            ...
            ValidateFileSignInfos(itemsToSign,
                                  new Dictionary<string, List<SignInfo>>(),
                                  new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>(),
...
<FilesToSign Include=""{Uri.EscapeDataString(Path.Combine(_tmpDir, "PackageWithRelationships.vsix"))}"">
  <Authenticode>VsixSHA2</Authenticode>
        ...
        public void ZeroLengthFilesShouldNotBeSigned()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("ZeroLengthPythonFile.py"), new FileSignInfoEntry("3PartySHA2") }
            };
            ValidateFileSignInfos(itemsToSign, strongNameSignInfo, fileSignInfo, s_fileExtensionSignInfo, Array.Empty<string>());
        }
        ...
        public void FilesAreUniqueByName()
        {
            ...
            ValidateFileSignInfos(itemsToSign, new Dictionary<string, List<SignInfo>>(), new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>(), s_fileExtensionSignInfoWithCollisionId, new[]
            {
        ...
        public void SpecificFileSignInfos()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("test.jar", collisionPriorityId: "123"), new FileSignInfoEntry("JARCertificate") },
                { new ExplicitCertificateKey("test.ps1", collisionPriorityId: "123"), new FileSignInfoEntry("PS1Certificate") },
                { new ExplicitCertificateKey("test.psd1", collisionPriorityId: "123"), new FileSignInfoEntry("PSD1Certificate") },
                { new ExplicitCertificateKey("test.psm1", collisionPriorityId: "123"), new FileSignInfoEntry("PSM1Certificate") },
                { new ExplicitCertificateKey("test.psc1", collisionPriorityId: "123"), new FileSignInfoEntry("PSC1Certificate") },
                { new ExplicitCertificateKey("test.dylib", collisionPriorityId: "123"), new FileSignInfoEntry("DYLIBCertificate") },
                { new ExplicitCertificateKey("EmptyPKT.dll", collisionPriorityId: "123"), new FileSignInfoEntry("DLLCertificate") },
                { new ExplicitCertificateKey("test.vsix", collisionPriorityId: "123"), new FileSignInfoEntry("VSIXCertificate") },
                { new ExplicitCertificateKey("PackageWithRelationships.vsix", collisionPriorityId: "123"), new FileSignInfoEntry("VSIXCertificate2") },
                { new ExplicitCertificateKey("Simple.dll", collisionPriorityId: "123"), new FileSignInfoEntry("DLLCertificate2") },
                { new ExplicitCertificateKey("Simple.nupkg", collisionPriorityId: "123"), new FileSignInfoEntry("NUPKGCertificate") },
                { new ExplicitCertificateKey("Simple.symbols.nupkg", collisionPriorityId: "123"), new FileSignInfoEntry("NUPKGCertificate2") },
                { new ExplicitCertificateKey("ProjectOne.dll", "581d91ccdfc4ea9c", ".NETFramework,Version=v4.6.1", "123"), new FileSignInfoEntry("DLLCertificate3") },
                { new ExplicitCertificateKey("ProjectOne.dll", "581d91ccdfc4ea9c", ".NETStandard,Version=v2.0", "123"), new FileSignInfoEntry("DLLCertificate4") },
                { new ExplicitCertificateKey("ProjectOne.dll", "581d91ccdfc4ea9c", ".NETCoreApp,Version=v2.0", "123"), new FileSignInfoEntry("DLLCertificate5") },
                { new ExplicitCertificateKey("filewithoutextension", collisionPriorityId: "123"), new FileSignInfoEntry("MacDeveloperHarden") },
                { new ExplicitCertificateKey("SPCNoPKT.dll", collisionPriorityId: "123"), new FileSignInfoEntry("None") },
                { new ExplicitCertificateKey("Simple.exe", collisionPriorityId: "1234"), new FileSignInfoEntry("MacDeveloperHardenWithNotarization") },
            };
        ...
        public void ExecutableTypeFileSignInfos()
        {
            ...
            var fileSignInfo = new Dictionary<ExplicitCertificateKey, FileSignInfoEntry>()
            {
                { new ExplicitCertificateKey("windows-exe.exe", executableType: ExecutableType.PE, collisionPriorityId: "123"), new FileSignInfoEntry("WindowsCertificate") },
                { new ExplicitCertificateKey("linux-elf", executableType: ExecutableType.ELF, collisionPriorityId: "123"), new FileSignInfoEntry("LinuxCertificate") },
                { new ExplicitCertificateKey("macos-macho", executableType: ExecutableType.MachO, collisionPriorityId: "123"), new FileSignInfoEntry("MacDeveloperHarden") },
            };
