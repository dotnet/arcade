...
namespace Microsoft.DotNet.ServiceFabric.ServiceHost
{
    ...
    {
        public ActivityServiceRemotingMessageDispatcher(ServiceContext serviceContext, IService serviceImplementation, IServiceRemotingMessageBodyFactory serviceRemotingMessageBodyFactory)
            ...
            IServiceRemotingRequestMessage requestMessage)
        {
            ...
            if (headers.TryGetHeaderValue(ActivityServiceRemoting.OperationIdHeaderName, out byte[] operationIdBytes))
            {
                ...
                try
                {
                    ...
                    if (headers.TryGetHeaderValue(ActivityServiceRemoting.CorrelationContextHeaderName,
