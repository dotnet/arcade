...
namespace Microsoft.DotNet.SignTool
{
    internal readonly struct SignToolArgs
    {
        ...
        internal string MicroBuildDotNetPath { get; }
        ...
        internal SignToolArgs(string tempPath, string microBuildCorePath, bool testSign, string dotnetPath, string microBuildDotNetPath, string msbuildVerbosity, string logDir, string enclosingDir, string snBinaryPath, string wixToolsPath, string tarToolPath, string pkgToolPath, int dotnetTimeout)
        {
            TempDir = tempPath;
            MicroBuildCorePath = microBuildCorePath;
            TestSign = testSign;
            DotNetPath = dotnetPath;
            MicroBuildDotNetPath = microBuildDotNetPath;
