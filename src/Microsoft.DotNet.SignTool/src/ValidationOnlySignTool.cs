...
namespace Microsoft.DotNet.SignTool
{
    ...
    internal sealed class ValidationOnlySignTool : SignTool
    {
        ...
        public override SigningStatus VerifySignedPkgOrAppBundle(TaskLoggingHelper log, string filePath, string pkgToolPath, string dotnetPath) => SigningStatus.Signed;
    }
}
