...
# endif
        ...
        internal static SigningStatus IsSignedPkgOrAppBundle(TaskLoggingHelper log, string filePath, string pkgToolPath, string dotnetPath)
        {
            ...
            return ZipData.RunPkgProcess(filePath, null, "verify", pkgToolPath, dotnetPath) ? SigningStatus.Signed : SigningStatus.NotSigned;
        }
