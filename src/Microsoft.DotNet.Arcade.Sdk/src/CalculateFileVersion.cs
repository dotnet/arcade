...
namespace Microsoft.DotNet.Arcade.Sdk
{
    ...
    /// </summary>
    public class CalculateFileVersion : Task
    {
        ...
        private void ExecuteImpl()
        {
            ...
            try
            {
                yy = int.Parse(OfficialBuildId.Substring(2, 2));
                mm = int.Parse(OfficialBuildId.Substring(4, 2));
                dd = int.Parse(OfficialBuildId.Substring(6, 2));
                r = int.Parse(OfficialBuildId.Substring(9));
            }
            catch
            {
                yy = mm = dd = r = -1;
            ...
            {
                Log.LogError($"Invalid format of {nameof(OfficialBuildId)}: {OfficialBuildId}");
                return;
            }
