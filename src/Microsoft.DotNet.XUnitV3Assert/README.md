# Custom Version of Xunit V3 Assert

## Origin/Attribution

This is a fork of the code in https://github.com/xunit/assert.xunit for building the
`Microsoft.DotNet.XUnitV3Assert` NuGet package. See `../../THIRD-PARTY-NOTICES.TXT` for the license for this code.
...
2. Run the pull command. From the root of the repo run: `git subtree pull --squash --prefix src/Microsoft.DotNet.XUnitV3Assert/src https://github.com/xunit/assert.xunit <YOUR-PREFERRED-VERSION>`
