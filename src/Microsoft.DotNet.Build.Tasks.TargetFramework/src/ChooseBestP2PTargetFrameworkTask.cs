...
namespace Microsoft.DotNet.Build.Tasks.TargetFramework
{
    public class ChooseBestP2PTargetFrameworkTask : BuildTask
    {
        ...
        {      
            ...
            {                
                string BestTargetFramework = targetFrameworkResolver.GetBestSupportedTargetFramework(projectReference.GetMetadata("TargetFrameworks").Split(';'), TargetFrameworkOsGroup);
