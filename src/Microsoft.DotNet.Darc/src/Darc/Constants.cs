...
namespace Microsoft.DotNet.Darc
{
    public class Constants
    {
        ...
        {
            "Merge policies an optional set of policies that, if satisfied, mean that an",
            "auto-update PR will be automatically merged. A PR is only merged automatically if policies",
            "exist and all policies are satisfied.",
            "In YAML, policies are specified in a list using the following form:",
            "- Name: <name of policy>",
            "  Properties:",
            "  - <property set>",
            "Each policy has a different set of required policies. See below for available policies",
            "",
