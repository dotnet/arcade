...
namespace Microsoft.DotNet.DarcLib
{
    public class Remote : IRemote
    {
        ...
        private async Task CommitFilesForPullRequest(string repoUri, string branch, string assetsProducedInCommit, IEnumerable<DependencyDetail> itemsToUpdate, string pullRequestBaseBranch = null, string pullRequestTitle = null, string pullRequestDescription = null)
        {
            ...
            await _gitClient.PushCommitsAsync(dependencyFilesToCommit, repoUri, pullRequestBaseBranch);
            ...
            if (arcadeItem != null)
            {
                await _gitClient.PushCommitsAsync(await GetScriptCommitsAsync(repoUri, branch, assetsProducedInCommit, pullRequestBaseBranch), repoUri, pullRequestBaseBranch);
            }
        }
    }
}
