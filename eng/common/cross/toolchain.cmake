...
elseif (ILLUMOS)
  ...
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only armel, arm, arm64, ppc64 and x86 are supported!")
endif()
...
if((TARGET_ARCH_NAME MATCHES "^(arm|armel|arm64|ppc64)$" AND NOT "$ENV{__DistroRid}" MATCHES "android.*") OR ILLUMOS)
