...
elseif(TARGET_ARCH_NAME STREQUAL "ppc64el")
...
elseif (ILLUMOS)
  ...
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only armel, arm, armv6, arm64, ppc64el, s390x and x86 are supported!")
endif()
...
if((TARGET_ARCH_NAME MATCHES "^(arm|armv6|armel|arm64|ppc64el|s390x)$" AND NOT ANDROID) OR ILLUMOS)
