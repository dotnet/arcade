...
try {
  ...
  try {
    ...
    # Do not supply a GitHub credential. This validates whether the current dependency graph can be
    # updated using its public metadata and the AzDO credential used for the internal mirror.
