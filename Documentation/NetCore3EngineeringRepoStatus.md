...
| [ASP.Net](https://github.com/dotnet/arcade/issues/676)              | namc     | ?                    |             | No response |
...
| ------------------------------------------------------------------- | -------- |:--------------------:| ----------- | ----- |
| Arcade                                                              | mawilkie | September 2018       | Completed   | |
| [ASP.Net](https://github.com/dotnet/arcade/issues/674)              | namc     | ?                    |             | No response |
...
| ------------------------------------------------------------------- | -------- |:--------------------:| ----------- | ----- |
| Arcade                                                              | mawilkie | September 2018       | Completed   | |
| [ASP.Net](https://github.com/dotnet/arcade/issues/673)              | namc     | ?                    |             | No response |
