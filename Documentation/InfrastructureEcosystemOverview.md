...
- **CI/Build Automation** – The set of software and services that automates the procurement of environments, scheduling of CI jobs, feedback to GitHub, etc.  Generally, this is Azure DevOps Pipelines with a set of additional functionality provided by .NET Core.
