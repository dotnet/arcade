...
- task: PublishBuildArtifacts@1
    ...
    inputs:
      PathtoPublish: '$(Build.Repository.LocalPath)\artifacts\log\$(BuildConfiguration)'
...
```yml
  ...
  - task: ms-vscs-artifact.build-tasks.artifactDropTask-1.artifactDropTask@0
    inputs:
      ...
      sourcePath: '$(Build.Repository.LocalPath)\artifacts\OptProf\$(BuildConfiguration)\Data'
      toLowerCase: false
      usePat: false
  ...
  - task: ms-vseng.MicroBuildTasks.0e9d0d4d-71ec-4e4e-ae40-db9896f1ae74.MicroBuildBuildVSBootstrapper@2
    inputs:
      ...
      outputFolder: '$(Build.Repository.LocalPath)\artifacts\VSSetup\$(BuildConfiguration)\Insertion'
