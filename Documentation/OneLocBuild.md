...
| `CeapexPat` | `$(dn-bot-ceapex-package-r)` | PAT used to access the Ceapex feeds when `CeapexServiceConnection` is empty or the pipeline runs outside a project that supports the WIF path. |
