...
* the `XUnitRunnerVersion` (the version of the xUnit nuget package you want to use, e.g. `2.6.7-pre.5`).
...
```yaml
  - template: /eng/common/templates/steps/send-to-helix.yml
    parameters:
      ...
      XUnitRunnerVersion: 2.6.7-pre.5 # specify the version of xUnit runner you wish to use here
