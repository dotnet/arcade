...
* the `XUnitRunnerVersion` (the version of the xUnit nuget package you want to use, e.g. `2.9.2`).
...
```yaml
  - template: /eng/common/templates/steps/send-to-helix.yml
    parameters:
      ...
      XUnitRunnerVersion: 2.9.2 # specify the version of xUnit runner you wish to use here
