...
4. Add the general testing feed (https://pkgs.dev.azure.com/dnceng/public/_packaging/general-testing/nuget/v3/index.json) to your branch's NuGet.config file. 
