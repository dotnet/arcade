...
| AkaMSChannelName | The name that should be used for creating Aka.ms links for this channel. A specified build quality will be appended to this value if supplied. |   |
...
| FilenamesToExclude | List of files to exclude from creating aka.ms links |   |  
